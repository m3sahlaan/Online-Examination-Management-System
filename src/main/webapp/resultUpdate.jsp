...
<div class="container">
    <h1>Submit Result</h1>
    <form action="ResultUpdate" method="POST" id="resultForm">
        <!-- Error message area -->
        ...
        <input type="number" id="scheduleID" name="ResultID" value="<%= resultID != null ? scheduleID : "" %>" readonly>

        <label for="scheduleID">Schedule ID:</label>
        <input type="number" id="scheduleID" name="scheduleID" value="<%= scheduleID != null ? scheduleID : "" %>" required>

        <label for="totalMarks">Total Marks:</label>
        <input type="number" id="totalMarks" name="totalMarks" value="<%= totalMarks != null ? totalMarks : "" %>" required>

        <label for="grade">Grade:</label>
        <input type="text" id="grade" name="grade" value="<%= grade != null ? grade : "" %>" maxlength="2" required>

        <label for="resultStatus">Result Status:</label>
        <select id="resultStatus" name="resultStatus" required>
            <option value="">Select status</option>
            <option value="pass" <%= "pass".equals(resultStatus) ? "selected" : "" %>>Pass</option>
            <option value="fail" <%= "fail".equals(resultStatus) ? "selected" : "" %>>Fail</option>
        </select>

        <input type="submit" value="Submit Result" name="submit">
    </form>
</div>
